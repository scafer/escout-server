...
public class User
{
    ...
    [JsonIgnore] public string dataMap { get; set; }

    [NotMapped] public Dictionary<string, string> data { get; set; }

    [NotMapped] public Dictionary<string, string> displayOptions { get; set; }
}
